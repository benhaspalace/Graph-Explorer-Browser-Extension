/*!
 * jqts v0.0.8 — https://github.com/kentdotn/jqts (MIT License)
 * Pure-TypeScript jq clone, bundled for use as a browser global.
 * Rebuild: npx esbuild node_modules/jqts/dist/index.js --bundle \
 *   --format=iife --global-name=JQTS --outfile=vendor/jqts.js
 */
"use strict";
var JQTS = (() => {
  ...
  // node_modules/jqts/dist/scanner.js
  var require_scanner = __commonJS({
    "node_modules/jqts/dist/scanner.js"(exports) {
      "use strict";
  ...
  // node_modules/jqts/dist/stmt.js
  var require_stmt = __commonJS({
    "node_modules/jqts/dist/stmt.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.Statements = exports.isExprStatement = exports.ExprStatement = exports.DefFuncStatement = void 0;
      var DefFuncStatement = class {
        constructor(name) {
          this.name = name;
        }
        dump() {
  ...
  // node_modules/jqts/dist/expr.js
  var require_expr = __commonJS({
    "node_modules/jqts/dist/expr.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      var SpreadIndexer = class {
        dump() {
          return { spread: 0 };
        }
      };
      exports.SpreadIndexer = SpreadIndexer;
      var IndexedExpr = class {
      ...
      var BinaryOperatorExpr = class {
        ...
        dump() {
          var _a, _b;
          return {
            [this.op]: [(_a = this.lhs) === null || _a === void 0 ? void 0 : _a.dump(), (_b = this.rhs) === null || _b === void 0 ? void 0 : _b.dump()]
          };
        }
      };
      exports.BinaryOperatorExpr = BinaryOperatorExpr;
      var ParallelExpr = class {
        constructor() {
          this.exprs = [];
        }
        push(expr) {
        ...
        dump() {
          ...
          if (this.exprs.length < 2) {
            return (_a = this.exprs[0]) === null || _a === void 0 ? void 0 : _a.dump();
          }
          return {
  ...
  // node_modules/jqts/dist/parser.js
  var require_parser = __commonJS({
    "node_modules/jqts/dist/parser.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      function parseNumberLiteral(scanner) {
        ...
        if (result) {
          return new expr_1.LiteralExpr(parseFloat(result[0]));
        } else {
          return null;
        }
      }
      ...
      function parseStringLiteral(scanner) {
        ...
        while (scanner.target.length > 0) {
          ...
          if (scanner.scan(quote)) {
            return new expr_1.StringLiteralExpr(parts);
          }
          if (scanner.scan("\\", false)) {
            throw new ParseError(`escape sequence is not supported yet: ${scanner.target}`);
          }
        }
      ...
      function parseIdentifier(scanner) {
        ...
        if (id) {
          return new expr_1.IdExpr(id);
        }
        return null;
      }
      function parseDoulbeDot(scanner) {
        if (scanner.scan("..")) {
          return new expr_1.RecursiveDescendantExpr();
        }
        return null;
      }
      function parseDot(scanner) {
        if (scanner.scan(".")) {
          return new expr_1.IdentityExpr();
        }
        return null;
      }
      function parseArrayElement(scanner) {
        ...
        while (scanner.target.length > 0) {
          ...
          if (!next) {
            throw new ParseError(`missing right side expression right of '|': ${scanner.target}`);
          }
          root.push(next);
        }
        return root;
      ...
      function parseArrayLikeIndexer(scanner) {
        ...
        if (isRange) {
          return new expr_1.RangeIndexer(start, last);
        } else if (start === null) {
          return new expr_1.SpreadIndexer();
        } else {
          return new expr_1.KeyIndexer(start);
        }
      }
      function parseDotIndexer(scanner) {
        ...
        const str = parseStringLiteral(scanner);
        if (str) {
          return new expr_1.KeyIndexer(str);
        }
        const id = parseIdentifier(scanner);
        if (id) {
          return new expr_1.KeyIndexer(id);
        }
        return null;
      }
      ...
      function parseIndexedExpr(scanner) {
        if (scanner.target.length > 0) {
          ...
          if (scanner.scan("?")) {
            lhs = new expr_1.OptionalExpr(lhs);
          }
          while (scanner.target.length > 0) {
      ...
      function parseLogicalAndExpr(scanner) {
        ...
        while (scanner.target.length > 0) {
          ...
          if (!subexpr)
            break;
          if (lhs) {
            lhs = new expr_1.BinaryOperatorExpr("and", lhs, subexpr);
          } else {
            lhs = subexpr;
          }
      ...
      function parseLogicalOrExpression(scanner) {
        ...
        while (scanner.target.length > 0) {
          ...
          if (!subexpr)
            break;
          if (lhs) {
            lhs = new expr_1.BinaryOperatorExpr("or", lhs, subexpr);
          } else {
            lhs = subexpr;
          }
      ...
      function parseAlternativeExpression(scanner) {
        ...
        while (scanner.target.length > 0) {
          ...
          if (!subexpr)
            break;
          if (lhs) {
            lhs = new expr_1.BinaryOperatorExpr("//", lhs, subexpr);
          } else {
            lhs = subexpr;
          }
          const result = scanner.scan("//");
      ...
      function parseParallelExpression(scanner) {
        ...
        while (scanner.target.length > 0) {
          ...
          const next = parseStandaloneExpression(scanner);
          if (!next) {
            throw new ParseError(`missing expr right side of ',': ${scanner.target}`);
          }
          root.push(next);
        }
        return root;
      ...
      function parseStatement(scanner) {
        if (scanner.target.length > 0) {
          ...
          const expr = parseExpression(scanner);
          if (expr) {
            return new stmt_1.ExprStatement(expr);
          }
        }
        return null;
      }
      function parseStatements(scanner) {
        ...
        if (scanner.target.length > 0) {
          throw new ParseError(`cannot parse whole pattern: consumed = ${JSON.stringify(stmts.dump())} rest = <${scanner.target}>`);
        }
        return stmts;
      }
  ...
  // node_modules/jqts/dist/context.js
  var require_context = __commonJS({
    "node_modules/jqts/dist/context.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      var ContextWithTarget = class extends Context {
  ...
  // node_modules/jqts/dist/eval/error.js
  var require_error = __commonJS({
    "node_modules/jqts/dist/eval/error.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      var UnexpectedIdError = class extends RuntimeError {
        constructor(id) {
  ...
  // node_modules/jqts/dist/eval/ensure.js
  var require_ensure = __commonJS({
    "node_modules/jqts/dist/eval/ensure.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      function ensureValue(value) {
        ...
        if ("id" in value) {
          throw new error_1.UnexpectedIdError(value.id);
        }
        return value.value;
      }
      ...
      function ensureNumberValue(value) {
        ...
        if (typeof value.value !== "number") {
          throw new error_1.RuntimeError(`unexpected non-number value: ${value.value}`);
        }
        return value.value;
      }
      ...
      function ensureArrayIndexable(value, size) {
        ...
        if ("id" in value) {
          throw new error_1.RuntimeError(`unexpected identifier for array index: ${value.id}`);
        }
        if (typeof value.value === "number") {
  ...
  // node_modules/jqts/dist/eval/utility.js
  var require_utility = __commonJS({
    "node_modules/jqts/dist/eval/utility.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      function mergeObject(lhs, rhs, overwrite) {
        ...
        Object.keys(rhs).forEach((key) => {
          ...
          if (key in lhs) {
            const l = lhs[key];
            if (context_1.isJsonMap(l) && context_1.isJsonMap(r)) {
  ...
  // node_modules/jqts/dist/eval/functions/operators.js
  var require_operators = __commonJS({
    "node_modules/jqts/dist/eval/functions/operators.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      function multiplyOperator(lhs, rhs) {
        ...
        } else if (context_1.isJsonMap(lhs) && context_1.isJsonMap(rhs)) {
          return utility_1.mergeObject(lhs, rhs, false);
        }
      ...
      function divideOperator(lhs, rhs) {
        if (typeof lhs == "number" && typeof rhs == "number") {
          if (rhs === 0) {
            throw new error_1.RuntimeError(`divison by zero`);
          }
          return lhs / rhs;
      ...
      function addOperator(lhs, rhs) {
        if (lhs === null) {
          ...
          return utility_1.mergeObject(lhs, rhs, true);
        }
  ...
  // node_modules/jqts/dist/eval/functions/predefined.js
  var require_predefined = __commonJS({
    "node_modules/jqts/dist/eval/functions/predefined.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      function utf8bytelength(value) {
        if (typeof value !== "string") {
          throw new error_1.RuntimeError(`cannot get byte length of ${value}`);
        }
      ...
      function hasKey(input, key) {
        if (Array.isArray(input)) {
          if (typeof key !== "number") {
            throw new error_1.RuntimeError(`cannot call has(key) with number`);
          }
          return key < input.length;
        }
        if (context_1.isJsonMap(input)) {
          if (typeof key !== "string") {
            throw new error_1.RuntimeError(`cannot call has(key) with non-string: ${JSON.stringify(key)}`);
          }
          return key in input;
        }
      ...
      function has(input, key) {
        if (key === void 0) {
          throw new error_1.RuntimeError(`missing argment 'key' for has(key)`);
        }
      ...
      function _in(input, obj) {
        if (obj === void 0) {
          throw new error_1.RuntimeError(`missing argment 'obj' for in(obj)`);
        }
      ...
      function toEntries(input) {
        if (!context_1.isJsonMap(input)) {
          throw new error_1.RuntimeError(`cannot call to_entries against ${input}`);
        }
      ...
      function join(input) {
        if (!isArray(input)) {
          throw new error_1.RuntimeError(`cannot add non-array elements: ${input}`);
        }
        if (input.length === 0)
          return null;
      ...
      function anyOf(input) {
        if (!isArray(input)) {
          throw new error_1.RuntimeError(`cannot check any against non-array elements: ${input}`);
        }
        if (input.length === 0)
          return false;
      ...
      function allOf(input) {
        if (!isArray(input)) {
          throw new error_1.RuntimeError(`cannot check all against non-array elements: ${input}`);
        }
        if (input.length === 0)
          return true;
      ...
      function flattenRecursive(input, depth) {
        ...
        return input.reduce((acc, v) => [
          ...acc,
          ...isArray(v) ? flattenRecursive(v, depth ? depth - 1 : void 0) : [v]
        ], []);
      }
      function flattenArray(input, depth) {
        if (!isArray(input)) {
          throw new error_1.RuntimeError(`cannot flatten non-array: ${input}`);
        }
        if (depth !== void 0 && typeof depth !== "number") {
          throw new error_1.RuntimeError(`cannot call flatten(depth) with non-number depth: ${JSON.stringify(depth)}`);
        }
      ...
      function sortBy(values, keys2) {
        return keys2.map((key, index2) => ({ key, index: index2 })).sort((a, b) => utility_1.valueCompare(a.key, b.key)).map(({ index: index2 }) => values[index2]);
      }
      exports.sortBy = sortBy;
      function groupBy(values, keys2) {
        return [
          ...keys2.reduce((groups, key, i) => {
            var _a;
            return groups.set(key, [...(_a = groups.get(key)) !== null && _a !== void 0 ? _a : [], values[i]]);
          }, /* @__PURE__ */ new Map()).entries()
        ].sort((a, b) => utility_1.valueCompare(a[0], b[0])).map((x) => x[1]);
      }
      exports.groupBy = groupBy;
      function minIndex(input) {
        if (input.length == 0) {
          throw new Error(`cannot get the minimum element from empty array value: ${input}`);
        }
      ...
      function unique(input) {
        return [
          ...input.reduce((acc, v) => acc.add(v), /* @__PURE__ */ new Set()).values()
        ].sort();
      }
      ...
      function contains(input, target) {
        if (isString(input)) {
          if (!isString(target)) {
            throw new error_1.RuntimeError(`a non-string value ${JSON.stringify(target)} cannot be contained in a string`);
          }
          return input.indexOf(target) > 0;
        }
        if (isArray(input)) {
          if (!isArray(target)) {
            throw new error_1.RuntimeError(`a non-array value ${JSON.stringify(target)} cannot be contained in an array`);
          }
          return target.every((x) => input.some((y) => contains(y, x)));
        }
        if (isObject(input)) {
          if (!isObject(target)) {
            throw new error_1.RuntimeError(`a non-object value ${JSON.stringify(target)} cannot be contained in an object`);
          }
      ...
      function _indices(input, target, maxIndices = 0, reverse2 = false) {
        ...
        if (isArray(input)) {
          return indicesFromArray(input, isArray(target) ? target : [target], maxIndices, reverse2);
        }
      ...
      function startswith(input, target) {
        if (!isString(input)) {
          throw new error_1.RuntimeError(`cannot apply startswith against non-string value ${JSON.stringify(input)}`);
        }
        if (!isString(target)) {
          throw new error_1.RuntimeError(`cannot apply startswith with non-string value ${JSON.stringify(target)}`);
        }
      ...
      function combinations(input, n) {
        if (n === void 0) {
          if (!isArrayOfArray(input)) {
            throw new error_1.RuntimeError(`cannot get combinations from array of non-arrays: ${JSON.stringify(input)}`);
          }
          return _combinations(...input);
        } else {
          if (!isNumber(n)) {
            throw new error_1.RuntimeError(`unexpected non-number: ${JSON.stringify(n)}`);
          }
  ...
  // node_modules/jqts/dist/eval/functions/index.js
  var require_functions = __commonJS({
    "node_modules/jqts/dist/eval/functions/index.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      function forEachInvocation(ctx, args, fn) {
        return new context_1.Context(...utility_1.flatten(ctx.values.map((input) => (
          // so... if we know all args are independent on context,
          // we can evaluate args only once...
          forEachArgs(args.map((arg) => arg.evaluate(new context_1.Context(input))), (args2) => fn(input, args2))
        ))));
      }
      ...
      function standardNumericFunction(name, fn) {
        return standardFunction((input, ...args) => {
          if (!predefined_1.isNumber(input)) {
            throw new error_1.RuntimeError(`cannot apply function ${name} against non-number: ${JSON.stringify(input)}`);
          }
          return fn(input, ...args);
        });
      }
      var StandardFunctionEvaluator = class {
        ...
        return (ctx, args) => {
          return forEachInvocation(ctx, args, (input, args2) => {
            ...
            if (result === void 0)
              return [];
            if ("value" in result) {
              return utility_1.isFalsy(result.value) ? [] : [input];
            } else {
              return [result];
            }
          });
      ...
      function standardArrayFunction(fn) {
        return standardFunction((input, ...args) => {
          if (!Array.isArray(input)) {
            throw new error_1.RuntimeError(`unexpected non-array input: ${JSON.stringify(input)}`);
          }
          return fn(input, ...args);
        });
      }
      ...
      exports.functions = /* @__PURE__ */ new Map([
          ...
          (ctx, [arg]) => {
            if (!arg) {
              return new context_1.Context({
                error: new error_1.RuntimeError(`missing argment for map`)
              });
            }
            return new __1.ArrayEvaluator([
              new __1.PipedEvaluator([
        ...
        [
          "with_entries",
          (ctx, args) => new __1.PipedEvaluator([
        ...
        [
          ...
          standardFunction((_, message) => {
            if (message === void 0) {
              throw new error_1.RuntimeError(`missing argment for map`);
            }
            if (typeof message !== "string") {
              throw new error_1.RuntimeError(`error message is not a string: ${message}`);
            }
        ...
        [
          "range",
          (input, args) => forEachInvocation(input, args, (_, args2) => {
        ...
        [
          "min_by",
          arrayFunctionWithKeyEvaluation((values, keys) => values[predefined_1.minIndex(keys)])
        ],
        ["max", standardArrayFunction((input) => input[predefined_1.maxIndex(input)])],
        [
          "max_by",
          arrayFunctionWithKeyEvaluation((values, keys) => values[predefined_1.maxIndex(keys)])
        ],
        ...
        [
          "combinations",
          (ctx, args) => forEachInvocation(ctx, args, (input, args2) => {
            predefined_1.combinations;
            const [nOrUndef] = args2.map(ensure_1.ensureNumberValue);
            const values = predefined_1.combinations(ensure_1.ensureArray(input), nOrUndef);
  ...
  // node_modules/jqts/dist/eval/index.js
  var require_eval = __commonJS({
    "node_modules/jqts/dist/eval/index.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      var ArrayEvaluator = class {
        ...
        evaluate(ctx) {
          try {
            ...
            return new context_1.Context(...xs.map((x) => ({
              value: x.map(ensure_1.ensureValue)
            })));
          } catch (error) {
      ...
      var ObjectFieldEvaluator = class {
        ...
        evaluate(ctx) {
          ...
          const pairs = utility_1.expandCombination([keys, values], [], (prev, xs) => {
      ...
      function indexedByKey(key, value) {
        ...
        if (context_1.isJsonMap(value)) {
          if (typeof key === "string") {
            return (_a = value[key]) !== null && _a !== void 0 ? _a : null;
          }
        ...
        if (Array.isArray(value)) {
          if (typeof key === "number") {
            ...
            return (_b = value[index]) !== null && _b !== void 0 ? _b : null;
          }
      ...
      var SliceEvaluator = class {
        ...
        evaluate(ctx) {
          ...
          const end = (_d = (_c = this.last) === null || _c === void 0 ? void 0 : _c.evaluate(ctx).values.map((v) => ensure_1.ensureArrayIndexable(v, sliceable.length))) !== null && _d !== void 0 ? _d : [
            sliceable.length
          ];
      ...
      var SpreadEvaluator = class {
        evaluate(ctx) {
          const target = ensure_1.ensureValue(ctx.target);
          if (context_1.isJsonMap(target)) {
            return new context_1.Context(...Object.keys(target).map((k) => target[k]).map((v) => ({ value: v })));
          } else if (Array.isArray(target)) {
            return new context_1.Context(...target.map((v) => ({ value: v })));
          } else {
            throw new error_1.RuntimeError(`cannot iterate over non-object/non-array value: ${target}`);
          }
        }
        dump() {
          return { spread: 0 };
      ...
      var FunctionCallEvaluator = class {
        constructor(funcname, args) {
          this.funcname = funcname;
          this.args = args;
        }
        evaluate(ctx) {
          ...
          if (func === void 0) {
            return new context_1.Context({
              error: new error_1.RuntimeError(`unknown function '${this.funcname}'`)
            });
          }
      ...
      var BinaryOperatorEvaluator = class {
        constructor(op, lhs, rhs) {
          this.op = op;
          this.lhs = lhs;
          this.rhs = rhs;
          if (op in knownOperators) {
            ...
            throw new error_1.RuntimeError(`cannot apply binary operator '${op}' with ${typeof lhs} and ${typeof rhs}`);
          }
        }
        evaluate(ctx) {
          return functions_1.standardFunction((_, lhs, rhs) => this.func(lhs, rhs))(ctx, [
            this.lhs,
            this.rhs
          ]);
        }
      ...
      function evaluate(evaluator, json) {
        const result = evaluator.evaluate(new context_1.Context({ value: json }));
  ...
  // node_modules/jqts/dist/optimize.js
  var require_optimize = __commonJS({
    "node_modules/jqts/dist/optimize.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      function optimizeObjectExpr(expr) {
        return new eval_1.ObjectEvaluator(expr.fields.map((f) => {
          ...
          if (!f.value) {
            return new eval_1.ObjectFieldEvaluator(keyEval, new eval_1.KeyEvaluator(keyEval));
          } else {
            return new eval_1.ObjectFieldEvaluator(keyEval, optimizeExpr(f.value));
          }
        }));
      }
      function optimizeIndexedExpr(expr) {
        if (expr.indexer instanceof expr_1.SpreadIndexer) {
          return new eval_1.IndexedEvaluator(optimizeExpr(expr.expr), new eval_1.SpreadEvaluator());
        }
        ...
        if (expr.indexer instanceof expr_1.KeyIndexer) {
          return new eval_1.IndexedEvaluator(optimizeExpr(expr.expr), new eval_1.KeyEvaluator(optimizeExpr(expr.indexer.key)));
        }
      ...
      function optimizeExpr(expr) {
        if (expr instanceof expr_1.FilteredExpr) {
          return optimizeFilteredExpr(expr);
        }
        if (expr instanceof expr_1.ParallelExpr) {
          return optimizeParallelExpr(expr);
        }
        if (expr instanceof expr_1.BinaryOperatorExpr) {
          return optimizeBinaryOperatorExpr(expr);
        }
        if (expr instanceof expr_1.IndexedExpr) {
          return optimizeIndexedExpr(expr);
        }
        if (expr instanceof expr_1.FunctionCallExpr) {
          return optimizeFunctaionCallExpr(expr);
        }
        if (expr instanceof expr_1.ObjectExpr) {
          return optimizeObjectExpr(expr);
        }
        if (expr instanceof expr_1.ArrayExpr) {
          return optimizeArrayExpr(expr);
        }
        if (expr instanceof expr_1.IdentityExpr) {
          return optimizeIdentityExpr(expr);
        }
        if (expr instanceof expr_1.IdExpr) {
          return optimizeIdExpr(expr);
        }
        if (expr instanceof expr_1.LiteralExpr || expr instanceof expr_1.StringLiteralExpr) {
          return optimizePrimitiveExpr(expr);
        }
        if (expr instanceof expr_1.OptionalExpr) {
      ...
      function optimize(stmts) {
        ...
        if (exprs.length > 1) {
          throw new error_1.RuntimeError(`too munknown expressions`);
        }
        const [root] = exprs;
        if (!root) {
          throw new error_1.RuntimeError(`no valid expression`);
        }
  ...
  // node_modules/jqts/dist/index.js
  var require_index = __commonJS({
    "node_modules/jqts/dist/index.js"(exports) {
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.JQ = void 0;
      ...
      var JQ = class _JQ {
        ...
        static compile(pattern) {
          ...
          return new _JQ(optimize_1.optimize(parser_1.parse(scanner)));
        }
        evaluate(value) {
