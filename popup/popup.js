...
var autoEvaluateBox = document.getElementById('setting-auto-evaluate');
...
function render(settings) {
  ...
  autoEvaluateBox.checked = normalized.autoEvaluate;
...
function save() {
  ...
  chrome.storage.local.get([STORAGE_KEY_SETTINGS], function (items) {
    ...
    settings.autoEvaluate = autoEvaluateBox.checked;
...
autoEvaluateBox.addEventListener('change', save);
